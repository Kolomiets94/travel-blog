...
const ProfilePage: React.FC = () => {
  ...
  useEffect(() => {
    if (user) {
      ...
      setBio(user.bio || '');
      setAvatarPreview(user.photo || '/assets/images/Ellipse1.png');
    }
  }, [user]);
          ...
          {!isEditing ? (
            <>
              <div className="profile-header">
                ...
                >
                  <img 
                    src="/assets/images/carbon_edit.png" 
                    alt="edit"
                    className="edit-icon"
                  />
                </button>
              ...
              <div className="profile-info">
                ...
                <div className="info-item">
                  ...
                  <span className="info-value">{country || 'Не указана'}</span>
                </div>
              </div>

              <div className="profile-bio">
                <span className="bio-label">О себе:</span>
                <p className="bio-text">{bio || 'Пока ничего не рассказано...'}</p>
              </div>
